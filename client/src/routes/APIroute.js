...
export const logInRouteProvider = `${host}/api/provider/signin`;
export const editUser = `${host}/api/client/edituser`;
export const editProvider = `${host}/api/provider/edit`;